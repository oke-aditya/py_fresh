...
## Step 1: Forking and Installing template_ml
...
​2. Download a copy of your remote username/template_ml repo to your
local machine. This is the working directory where you will make
changes:

```bash
$ git clone https://github.com/oke-aditya/template_ml.git
```
...
1.  Set the upstream to sync with this repo. This will keep you in sync
    with template_ml easily.

```bash
$ git remote add upstream https://github.com/oke-aditya/template_ml.git
```
...
command, from the template_ml folder:
...
(github.com/username/template_ml)
...
template_ml main repo and GitHub will prompt you to create a pull
request.

#### 2. Confirm PR was created:

Ensure your pr is listed
[here](https://github.com/oke-aditya/template_ml/pulls)
...
> **note**
>
> Template_ml repository has CI checking. It will automatically check your code
> for build as well.